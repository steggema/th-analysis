...
'''
    ...
    parser.add_option('-i', '--input', dest='input_file', help='input file name', default='/afs/cern.ch/user/y/ytakahas/public/forJan/tH_BDTtraining_20141009/BDT_training_ss_f3.root', type='string')
